...
Get API Key: On the Google AI Studio page, look for and click the "Get API key" button. If you have already logged into ai studio, It should be on the top right of the page.



Create New API Key: Click "Create API key in new project" (or choose an existing project if you have one).



Copy Your Key: Your new Gemini API key will be generated and displayed. Immediately copy this key and store it in a secure location. 
