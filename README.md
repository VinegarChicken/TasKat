...
- **Right-click Integration**: Access PromptFile directly from Windows File Explorer
...
PromptFile analyzes generated scripts for potentially dangerous operations:
